...
import ActivityMonitorWidget from "../components/activity-monitor.js";

describe("ActivityMonitor widget", () => {
it("renders with default props", async () => {
const session = await createUIXTestSession(ActivityMonitorWidget);
