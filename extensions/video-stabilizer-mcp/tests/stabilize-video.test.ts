...
import StabilizeVideoWidget from "../components/stabilize-video.js";

describe("StabilizeVideo widget", () => {
it("renders with default props", async () => {
const session = await createUIXTestSession(StabilizeVideoWidget);
