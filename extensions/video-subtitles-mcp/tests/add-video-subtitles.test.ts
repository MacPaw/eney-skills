...
import AddVideoSubtitlesWidget from "../components/add-video-subtitles.js";

describe("AddVideoSubtitles widget", () => {
it("renders with default props", async () => {
const session = await createUIXTestSession(AddVideoSubtitlesWidget);
