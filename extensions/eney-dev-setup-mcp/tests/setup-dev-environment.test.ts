...
import SetupDevEnvironmentWidget from "../components/setup-dev-environment.js";

describe("SetupDevEnvironment widget", () => {
it("renders with default props", async () => {
const session = await createUIXTestSession(SetupDevEnvironmentWidget);
