...
import MeetGetSpace from "./components/google-meet/meet-get-space.js";
import MeetListParticipants from "./components/google-meet/meet-list-participants.js";
import MeetGetParticipantSessions from "./components/google-meet/meet-get-participant-sessions.js";
import MeetUpdateSpace from "./components/google-meet/meet-update-space.js";
...
uixServer.registerWidget(MeetGetSpace);
uixServer.registerWidget(MeetListParticipants);
uixServer.registerWidget(MeetGetParticipantSessions);
uixServer.registerWidget(MeetUpdateSpace);
